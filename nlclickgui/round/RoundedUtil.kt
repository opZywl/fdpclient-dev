...
import net.ccbluex.liquidbounce.ui.client.clickgui.style.styles.nlclickgui.ColorUtils
...
object RoundedUtil {
    ...
    @JvmField
    val roundedShader = ShaderUtil("roundedRect")
    @JvmField
    val roundedOutlineShader = ShaderUtil("fdpclient/shaders/roundRectOutline.frag")
    ...
    fun drawGradientRound(
        ...
        roundedGradientShader.setUniformf("color2", topLeft.red / 255f, topLeft.green / 255f, topLeft.blue / 255f, topLeft.alpha / 255f)
        roundedGradientShader.setUniformf(
            "color3",
        ...
        roundedGradientShader.setUniformf("color4", topRight.red / 255f, topRight.green / 255f, topRight.blue / 255f, topRight.alpha / 255f)
    ...
    fun drawCircle(x: Float, y: Float, radius: Float, color: Color) {
        ...
        GlStateManager.blendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA)
        roundedShader.init()
        ShaderUtil.setupRoundedRectUniforms(x, y, radius, radius, radius / 2 - 0.25f, roundedShader)
        roundedShader.setUniformf("color", color.red / 255f, color.green / 255f, color.blue / 255f, color.alpha / 255f)
